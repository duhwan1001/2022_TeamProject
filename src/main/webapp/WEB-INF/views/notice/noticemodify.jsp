    ...
    <div class="card-body col-10" style="left: 7%">
        <form class="was-validated">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="validationTextarea" placeholder="내용을 입력하세요" required
                          style="height: 300px">${n.noticeContent}</textarea>
                <div class="invalid-feedback">
                    내용은 필수사항입니다.
                </div>
            </div>
            ...
            <div class="clearfix" style="margin-bottom: 2em">
                <div class="float-left">
                    <button type="button" class="btn btn-primary" onclick="goNoticeMain()">목록
                    </button>
                </div>
                <div class="float-right">
                    <button type="button" class="btn btn-primary" onclick="noticeModify()">수정
                    </button>
